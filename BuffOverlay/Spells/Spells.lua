...
BuffOverlay.defaultSpells = {
    ...
    [51052] = { class = "DEATHKNIGHT", prio = 50 }, --Anti-Magic Zone
	[49016] = { class = "DEATHKNIGHT", prio = 50 }, --Unholy Frenzy
	[55233] = { class = "DEATHKNIGHT", prio = 50 }, --Vampiric Blood

    -- Druid
	[50334] = { class = "DRUID", prio = 40 },  --Berserk
	...
	[19574] = { class = "HUNTER", prio = 50 }, --Bestial Wrath (Pet)
    ...
    [1022] = { class = "PALADIN", prio = 10 }, --Blessing of Protection
        [5599] = { parent = 1022 },
        [10278] = { parent = 1022 },
    [19752] = { class = "PALADIN", prio = 10 }, --Divine Intervention
    [25771] = { class = "PALADIN", prio = 20 }, --Forbearance
	[31884] = { class = "PALADIN", prio = 30 }, --Avenging Wrath
	...
	[6940] = { class = "PALADIN", prio = 50 }, --Hand of Sacrifice
	[1038] = { class = "PALADIN", prio = 60 }, --Hand of Salvation
	[54428] = { class = "PALADIN", prio = 80 }, --Divine Plea

    -- Priest
    [47788] = { class = "PRIEST", prio = 10 }, --Guardian Spirit
    [27827] = { class = "PRIEST", prio = 10 }, --Spirit of Redemption
	[10060] = { class = "PRIEST", prio = 10 }, --Power Infusion
	...
	[57934] = { class = "ROGUE", prio = 70 },  --Tricks of the Trade

    -- Shaman
	[51514] = { class = "SHAMAN", prio = 20 }, --Hex
    ...
    [7812] = { class = "WARLOCK", prio = 50 }, --Voidwalker Sac
        ...
        [19442] = { parent = 7812 },
        [19443] = { parent = 7812 },
	[59672] = { class = "WARLOCK", prio = 50 }, --Metamorphosis
